...
func (ec *executionContext) marshalNUser2githubᚗcomᚋefadᚋprueba2ᚑordenesᚋinternalᚋdeliveryᚋgraphqlᚋmodelᚐUser(ctx context.Context, sel ast.SelectionSet, v model.User) graphql.Marshaler {
